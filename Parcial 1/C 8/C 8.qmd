...
-   Probabilidad de que el precio se ubique entre 11 y 13 pesos en un año.
    ...
    ```{r}
    mean(11<p_final & 13>p_final)
    mean(p_final<13)-mean(p_final<11)
...
-   
    ...
    ```{r}
    mean(9.472295 <p_final & 17.06231 >p_final)
    ```

-   Probabilidad de que el precio aumente
...
-   Probabilidad de que el precio incremente un 30% de su valor inicial
